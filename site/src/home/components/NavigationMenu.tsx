...
import { AccountPlusOutline, ClockAlertOutline, HumanBabyChangingTable, Printer } from 'mdi-material-ui';
    ...
    <List component="nav">
      ...
      <Collapse in={isAsmatExpanded} timeout="auto" unmountOnExit>
        <List component="div" disablePadding className={classes.nested}>
          ...
          <ListItemLink label="Rappels d'adhésion" icon={<ClockAlertOutline/>} to="/asmats/reminds"/>
          <ListItemLink label="Imprimer une liste" icon={<Printer/>} to="/asmats/print"/>
        </List>
      </Collapse>
    </List>
  );
